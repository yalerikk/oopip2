...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //MedicinesFunc.text("text", basket);
        while (true) {
            System.out.println("\nВыберите вид сортировки счета корзины:\n1) Сортировка по возрастанию;\n2) Сортировка по убыванию.");
            int choice = checkValue.getInput(1, 2);

            Runnable sorter = chooseSortingMethod(choice, basket);
    ...
    public static Runnable chooseSortingMethod(int choice, List<Medicines> basket) {
